...
export default function DescriptionWebflow() {
  return (
    <>
      <div className="description-webflow md:grid md:grid-cols-7 lg:grid-cols-8 md:items-center bg-grey-light md:p-10 px-3 py-10 ">
        <img src={icon} alt="" className="md:mb-0 mb-10 " />
        <div className="first-webflow-comp md:col-span-4 lg:col-span-5 md:mb-0 mb-8">
